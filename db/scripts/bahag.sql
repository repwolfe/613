...
insert into bahag values (44, 592, 4, 44, 'ועל אשת אחיו');
...
insert into bahag values (496, 826, 7, 148, 'שמחת כלה');
...
insert into bahagNotes values (349, null, 'For some reason Rav Troib claims the Rambam didn''t count this mitzvah. The Bahag doesn''t count #2 of the Rambam, so perhaps Rav Troib viewed this as a fusion of the two? See also Rav Perla''s commentary to Rav Saadiah Gaon, Aseh #3. However, see the note to Bahag Aseh #34');
...
insert into bahagNotes values (382, null, 'Rav Troib doesn''t cross reference the Rambam''s mitzvah to bury the dead (#231). Seemingly there shouldn''t be any dispute. However, the Rambam at the beginning of Shoresh #1 attacks the Bahag for counting this mitzvah. The Nosei Keilim, as well as the Nesiv Mitzvosecha and Rav Perla understand that the Bahag''s mitzvah to bury the deceased is different than the Rambam''s, although they all give different explanations why');
