...
insert into verses values (6, 5, 26, 17, 'את-יקוק האמרת היום להיות לך לאלקים וללכת בדרכיו ולשמר חקיו ומצותיך ומשפטיו ולשמע בקלו', null);
